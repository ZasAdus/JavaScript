...
function getTriangleVertices(index) {
    switch (index) {
        case 1:
            return [-0.5, 0, 0.25, 0.88, 0.82, 0, 0, 0.6, 0.2, 0.8, -0.25, 0.43, 1, 1, 0.4];
        case 2:
            return [-0.25, 0.43, 1, 1, 0.4, 0.25, 0.43, 0.25, 0.88, 0.82, 0, 0, 0.6, 0.2, 0.8];
        case 3:
            return [0, 0, 0.6, 0.2, 0.8, 0.25, 0.43, 0.25, 0.88, 0.82, 0.5, 0, 1, 1, 0.4];
        case 4:
            return [-0.5, 0, 0.25, 0.88, 0.82, 0, 0, 0.6, 0.2, 0.8, -0.25, -0.43, 1, 1, 0.4];
        case 5:
            return [0, 0, 0.6, 0.2, 0.8, -0.25, -0.43, 1, 1, 0.4, 0.25, -0.43, 0.25, 0.88, 0.82];
        case 6:
            return [0, 0, 0.6, 0.2, 0.8, 0.25, -0.43, 0.25, 0.88, 0.82, 0.5, 0, 1, 1, 0.4];
        default:
            return [];
